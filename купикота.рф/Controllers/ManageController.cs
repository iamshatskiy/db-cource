...
using купикота.рф.Models.ManageViewModels;
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<IActionResult> Index(IndexViewModel model)
        {
            ...
            if (model.city != null)
            {
                ...
                {
                    throw new ApplicationException($"Unexpected error occurred setting city name for user with ID '{user.Id}'.");
                }
            }
            ...
            if (model.Surname != null)
            {
                ...
                var setSurName = await _userManager.UpdateAsync(user);
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("купикота.рф"),
